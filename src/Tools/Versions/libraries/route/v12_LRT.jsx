...
export default function v12_LRT() {
  return {
    "getting-started": {
        ...
        install: {
          ...
          code: (
            <Fragment>
              ...
              <SupportVersion title={"Lion-Route"} version={"8.4"} />
...
Route::delete('users/{id}', function(UsersController $usersController, string $id) {
    return $usersController->method($id);
});
...
Route::delete('users/{id}', [UsersController::class, 'method']);
...
Route::get('users/{id}', [UsersController::class, 'method']);
...
Route::match([Route::GET, Route::POST], 'users', function(UsersController $usersController): mixed {
...
Route::match([Route::GET, Route::POST], 'users', [UsersController::class, 'createUsers']);
            ...
            <Fragment>
              ...
              <Fragment>
                ...
                <p>
                  ...
                  middleware.
                  {"['header' => HeaderMiddlewre::class]"} is the basic syntax
...
Route::middleware(['header', 'prefix' => 'api'], function(): void {
    Route::post('login', fn(): array => ['status' => 'success', 'message' => 'Hello world']);
});
`}
              />
...
Route::post('login', fn(): array => ['status' => 'success', 'message' => 'Hello world'], ['header']);

// or

Route::post('login', [Example::class, 'postMethod'], ['header']);
`}
              />
            </Fragment>
          ),
...
Route::post('users', function(UsersController $usersController): mixed {
    return $usersController->method();
});
...
Route::post('users/{id}', [UsersController::class, 'method']);
...
Route::put('users', function(UsersController $usersController): mixed {
    return $usersController->method();
});
...
Route::put('users/{id}', [UsersController::class, 'method']);
